...
public class MineFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void initOptionBars(View view) {
        ...
        optionBarAnnouncement.init(R.mipmap.ic_launcher, getString(R.string.option_announcement), false,"", R.drawable.ic_arrow_right);

        CompoundOptionBar optionBarFeedback = view.findViewById(R.id.compound_option_bar_feedback);
        optionBarFeedback.init(R.mipmap.ic_launcher, getString(R.string.option_feedback), false, "", R.drawable.ic_arrow_right);

        CompoundOptionBar optionBarAbout = view.findViewById(R.id.compound_option_bar_about);
        optionBarAbout.init(R.mipmap.ic_launcher, getString(R.string.option_about), false, "", R.drawable.ic_arrow_right);
    }
